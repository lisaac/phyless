            ...
            <For each={store.items()}>
              {(img) => (
                <tr class="transition-colors hover:bg-white/[0.03]">
                  ...
                  <td class="px-3 py-2 align-middle text-center text-xs text-zinc-400">{fmtSize(img.Size)}</td>
                  <td class="px-3 py-2 align-middle text-center text-xs">
                  ...
                  <td class="px-3 py-2 align-middle text-center text-xs text-zinc-400">{fmtDate(img.Created)}</td>
                </tr>
              )}
            </For>
          </tbody>

...
export type ComposeVerb = "up" | "stop" | "pause" | "down" | "restart" | "pull" | "build";
export const VERB_LABEL: Record<ComposeVerb, string> = { up: "Up", stop: "Stop", pause: "Pause", down: "Down", restart: "Restart", pull: "Pull", build: "Build" };

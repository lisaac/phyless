...
vi.mock("./components/shared/Layout", () => ({ Layout: (props: { children?: unknown }) => <>{props.children}</> }));
...
vi.mock("./components/containers/ContainerDetailPage", () => ({ ContainerDetailPage: () => <div>container-detail-page</div> }));
...
describe("route fallback", () => {
  it("redirects an unmatched URL to the home page", async () => {
    window.history.replaceState(null, "", "/missing/path");
    render(() => <App />);
